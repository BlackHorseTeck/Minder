...
export const ProjectForm = () => {
  ...
  const models: Model[] = [
    { name: "gemini", label: "Gemini-2.5 Flash", icon: <FcGoogle />, isPro: false },
    { name: "grok", label: "Grok 4 Fast", icon: null, isPro: true },
                      ...
                      return (
                        ...
                        >
                          ...
                          <span className="text-[10px] text-muted-foreground pl-6 mt-0.5">
                            ...
                            {model.name === "gemini" && "Lightweight and free"}
                            {model.name === "grok" && "X-powered fast model"}
                          </span>
                        </button>
                      );
                    })}
