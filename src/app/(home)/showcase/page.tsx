    ...
    <main className="pt-[16vh] px-4 md:px-12 max-w-6xl mx-auto flex flex-col gap-12">
      ...
      <section className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-2 gap-8">
        {features.map((feature, idx) => (
          <div
            key={idx}
            className="bg-background/80 backdrop-blur-sm border border-border rounded-xl p-6 flex flex-col gap-4 shadow-sm hover:shadow-md hover:border-primary transition-all cursor-pointer"
          >
